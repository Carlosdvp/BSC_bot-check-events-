...
const BNBFury_ADDRESS = '0x52ae96eBA0eb2EAD1fe9ccD32fF7902580f7AFf0'

let bnbfury = new web3.eth.Contract(BNBFury_ABI, BNBFury_ADDRESS)


// lets grab all the events from a certain past block to the current one - to make sure we have a connection

// I need to filter out by NewDeposit and Newcomes
// 0.28 BNB = 280000000000000000 ($104)
